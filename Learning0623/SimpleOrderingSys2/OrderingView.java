...
public class OrderingView {
    ...
    public void reviseOrder(){
        ...
        int memberNum = Utility_order.readInt(-1);
        if (!"".equals(memberNum)) {
    ...
    public void addOrders(){
        ...
        member.add(new MemberShip(1001, "金卡", 100));
        member.add(new MemberShip(1002, "银卡", 100));
        member.add(new MemberShip(1003, "普通", 100));
...
//        int spe = Utility_order.readInt();
        ...
        int memberNum = Utility_order.readInt();
